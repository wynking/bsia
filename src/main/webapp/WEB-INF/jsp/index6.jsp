...
<body class="container">
	...
	<div class="clearfix row" >
		...
		<aside class="left-menu pull-left col-sm-2">


			<div class="panel-group oneLevelNav-pannel" id="accordion" style="margin-top: 5px; ">
		...
		<section class="main-content pull-right col-sm-10">
