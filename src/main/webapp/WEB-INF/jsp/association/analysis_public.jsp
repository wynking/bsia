...
<div class="row" style="margin-top: 20px;">
	...
	<div class="panel-group col-sm-6">
		<div class="panel panel-info">
		    <div class="panel-heading">
		        <h3 class="panel-title">北京上市公司分布统计</h3>
		    </div>
		    <div class="panel-body">
		        <!-- 为ECharts准备一个具备大小（宽高）的Dom -->
		    <div id="chart-public" style="height:400px;"></div>
		    </div>
		</div>
	...
	<div class="panel-group col-sm-6">
		...
		<div class="panel panel-info">
		    ...
		    <div class="panel-body">
		        <!-- 为ECharts准备一个具备大小（宽高）的Dom -->
		    <div id="chartBar-public" style="height:400px;"></div>
		    </div>
		</div>
	</div>
	...
	function renderCylinder(resp){
		var chartHigh = echarts.init(document.getElementById('chart-public'));
		var option = {
					  title: {
			                //text: '北京高新企业分布统计'
			            },
	...
	function renderBar(resp){
		var chartBarHigh = echarts.init(document.getElementById('chartBar-public'));
